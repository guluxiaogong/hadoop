package com.antin.hbase.test.crud;
/*
...
//        conf.set("hbase.rootdir", "hdfs://zoe01:9000/hbase");
        //conf.set("hbase.zookeeper.quorum", "zoe01");
    ...
    public static void main(String[] args) {
        try {
            ...
            if (isExist(tableName)) {
                ...
                addRow(tableName, "<span style=\"font - family:Arial, Helvetica, sans - serif;\">henjun</span>", "info", "sex", "boy");
                ...
                addRow(tableName, "<span style=\"font - family:Arial, Helvetica, sans - serif;\">niaopeng</span>", "info", "sex", "girl");
...
//                System.out.println("表" + tableName + "存在吗？" + isExist(tableName));
    ...
    public static void put() throws IOException {
        HTable table = new HTable(conf, Bytes.toBytes("student"));
        Put put = new Put(Bytes.toBytes("rw0010"));
