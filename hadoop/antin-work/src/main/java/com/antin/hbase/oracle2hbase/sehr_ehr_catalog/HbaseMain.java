...
public class HbaseMain {
    ...
    public static void main(String[] args) throws Exception {
        String tableName = "sehr_ehr_catalog", hTableName = "sehr_ehr_catalog";
        int maps = 1;
...
//        conf.set("hbase.zookeeper.property.clientPort", "2181");
        ...
        DataDrivenDBInputFormat.setInput(job, SehrEhrCatalogModel.class, "select * from (select rownum id ,code,name,quantity,t.xml_format.getclobval() xml_format,status from " + tableName + " t) b where $CONDITIONS", "select MIN(t.id), MAX(t.id) from (select rownum as id from " + tableName + ") t");
